...
class StyleController(BaseController):
    ...
    def _get_geoserver_catalog(self):
        ...
        api_url = config['ckanext.helix.vectorstorer.geoserver.api_url']
        username = config['ckanext.helix.vectorstorer.geoserver.username']
        password = config['ckanext.helix.vectorstorer.geoserver.password']
        catalog1 = Catalog(
    ...
    def _get_mapfile_layer(self, dataset_name):
        ...
        mapfile_folder = config['ckanext.helix.vectorstorer.mapserver.mapfile_folder']
