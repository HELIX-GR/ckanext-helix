...
from ckanext.helix.storers.vector import vector
from ckanext.helix.storers.vector.resources import(
    WMSResource, DBTableResource, WFSResource)
from ckanext.helix.storers.vector.db_helpers import DB
from ckanext.helix.storers.vector.lib import utils
...
def _publish_layer_to_mapserver(
    ...
    from ckanext.helix.storers.vector import mapserver_utils
