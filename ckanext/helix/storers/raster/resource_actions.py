...
def _make_default_context():
    ...
    return {
        ...
        'temp_folder': config.get('ckanext.helix.rasterstorer.temp_dir', ""),
        'wms_base_url': config.get("ckanext.helix.rasterstorer.wms_base_url", ""),
        'wcst_import_url': config.get("ckanext.helix.rasterstorer.wcst_import_url", ""),
        'wcst_base_url': config.get("ckanext.helix.rasterstorer.wcst_base_url", ""),
        'gdal_folder': config.get("ckanext.helix.rasterstorer.gdal_folder", "")
        }
