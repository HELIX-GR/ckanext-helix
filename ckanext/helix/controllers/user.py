...
from ckanext.helix.storers.vector import resource_actions # Fixme: adapt
...
class UserController(BaseController):
    ...
    def _setup_template_variables(self, user_dict):
        def search_url(params):
            url = h.url_for(controller='ckanext.helix.controllers.user:UserController', action='show_dashboard_resources')
    ...
    def reject_resource(self, resource_id, parent):
        ...
        h.redirect_to(toolkit.url_for(
            controller='ckanext.helix.controllers.user:UserController',
            action=_action))
