...
from ckanext.helix.lib.dictization import unflatten
from ckanext.helix.lib.languages import Language
from ckanext.helix.lib.util import to_json, Breakpoint
from ckanext.helix.lib.metadata import schemata
from ckanext.helix.lib.metadata import types
from ckanext.helix.lib.metadata import bound_field
from ckanext.helix.lib.metadata.types import Object
...
class Controller(BaseController):
    ...
    def test_csw_hooks(self, id):
        from ckanext.helix.lib import pycsw_sync
    ...
    def test_formatter(self):
        from ckanext.helix.lib.metadata import formatter_for_field
        x = fixtures.inspire1
