...
class CommandDispatcher(CkanCommand):
    '''A command dispatcher for various helix-related subcommands'''

    __usage = '''paster [PASTER-OPTS] helix --config FILE [--setup-app] %(name)s [%(name)s-OPTS] ARGS'''
    ...
    def command(self):        
        ...
        self.logger = logging.getLogger('ckanext.helix')
        ...
        if spec:
            ...
            print 'The available helix commands are:\n'
