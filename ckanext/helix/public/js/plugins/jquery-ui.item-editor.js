...
jQuery(document).ready(function ($) {
    ...
    $.widget('helix.itemEditor', $.helix.fieldwidget, {
        widgetEventPrefix: 'helix-item_editor:',
        ...
        _checkSource: function (src)
        {
            ...
            if (src instanceof $.helix.itemEditor) {
                $src = src.element
            } else {
            ...
            if (!$src.length) {
                ...
                throw new Error('Cannot copy: ' +
                    'source doesnt seem to be an helix.itemEditor widget')
            } else if (src == this) { 
