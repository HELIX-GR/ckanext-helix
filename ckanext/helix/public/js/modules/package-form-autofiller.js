...
this.ckan.module('package-form-autofiller', function ($, _) {
  ...
  return {
    ...
    samples: {
        ...
        'optional_notes': 'Ελληνική περιγραφη 1',
        ...
        'optional_title': 'Ελληνικός τίτλος 2',
        'optional_notes': 'Ελληνική περιγραφη 2',
        'related_pub': '10.12449/foo',
        ...
        'optional_title': 'Ελληνικός τίτλος 3',
        'optional_notes': 'Ελληνική περιγραφη 3',
        'related_pub': '10.12449/foo',
        ...
        'optional_notes': 'Ελληνική περιγραφη 4',
        'related_pub': '10.12449/foo',
