...
from ckanext.helix.lib.metadata.xml_serializers import object_xml_serialize_adapter
from ckanext.helix.lib.metadata.xml_serializers import xml_serializer_for_object
