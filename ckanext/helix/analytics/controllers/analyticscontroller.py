...
from ckanext.helix.analytics.controllers.orchestrator.server_orchestrator import ServerOrchestrator
import pylons.config as global_config
from ckanext.helix.analytics.controllers.orchestrator.tiling_orchestrator import TilingOrchestrator
...
class AnalyticsController(BaseController):
    ...
    def get_service_orchestrator(self):
        so = ServerOrchestrator(global_config.get("ckanext.helix.analytics.api_endpoint", ""),
                                global_config.get("ckanext.helix.analytics.rasdaman_endpoint", ""))
        return so

    def get_tiling_orchestrator(self):
        to = TilingOrchestrator(global_config.get("ckanext.helix.analytics.api_endpoint", ""),
                                global_config.get("ckanext.helix.analytics.rasdaman_endpoint", ""))
        return to
